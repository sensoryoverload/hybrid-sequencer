...
type
  ...
  private
    ...
    FLastIndex: Integer;
    FIndex: Integer;
    FAutomationCache: TAutomationCache;
  protected
  public
...
begin
  ...
  FAutomationCache := TAutomationCache.Create;
end;
...
begin
  ...
  FAutomationCache.AddAutomationCache(AAutomationData.ParameterId);
...
begin
  ...
  if lIndex <> -1 then
  begin
    FAutomationCache.DeleteAutomationCache(AAutomationData.ObjectID);
